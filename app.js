...
const personsImg = document.getElementById(`person-img`);
...
//Declare global variable to hold item selected (from reviews Array)
...
function displayReview(){
  personsImg.src = reviews[currentItem].img;
